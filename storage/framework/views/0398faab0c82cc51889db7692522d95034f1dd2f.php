        ...
        <div class="row">
            ...
            <div class="col-lg-8 flex-lg-right">
                <ul class="header-top-list">
                    ...
                    <li class="dropdown-trigger language-dropdown"><a href="<?php echo e(url('wishlist')); ?>"><i
                    ...
                    <li><a href="<?php echo e(url('checkout')); ?>"><i class="icons-left fas fa-share"></i> Checkout</a>
                    </li>
                    <li><a href="#" data-toggle="modal" data-target="#exampleModal"><i class="icons-left fas fa-lock"></i> Sign
                            In</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 d-flex flex-row justify-content-start align-item-center ">
                    ...
                    <div class="header-search-block  d-flex flex-row justify-content-start align-item-center" style="width:70%">
                    ...
                    <nav class="category-nav white-nav  " id="category-nav-hb">
                        <div>
                            ...
                            <ul class="category-menu">
                                ...
                                <li class="cat-item has-children"><a href="#">Comicas</a>
                                    <ul class="sub-menu">
                                        <li><a href="">Brake Tools</a></li>
                                        <li><a href="">Driveshafts</a></li>
                                        <li><a href="">Emergency Brake</a></li>
							...
							<div class="login-form">
								...
								<div class="row">
									...
									<div class="col-12 mb--20">
                                        ...
                                        <h6 class="w-100 text-right mt-4"> <a href="#">Forgot Your Password?</a> </h6>
									</div>
...
</div><?php /**PATH C:\xampp\htdocs\bookfactory17\bookfactory\resources\views/webpages/include/header.blade.php ENDPATH**/ ?>