                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="<?php echo e(url('product-details')); ?>" tabindex="0">Qpple cPad with
                                                        Retina
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="<?php echo e(url('product-details')); ?>">Simple Things You To Save BOOK</a>
                                            </h3>
                                        </div>
                                        <div class="product-card--body">
                                            <div class="card-image">
                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="<?php echo e(url('product-details')); ?>" tabindex="0">What You Can Learn
                                                        From
                                                        Bill Gates</a></h3>
                                            </div>
                                            <article>
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="<?php echo e(url('product-details')); ?>">3 Ways Create Better BOOK With</a>
                                            </h3>
                                        </div>
                                        <div class="product-card--body">
                                            <div class="card-image">
                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="<?php echo e(url('product-details')); ?>" tabindex="0">Never Changing
                                                        BOOK Will
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="<?php echo e(url('product-details')); ?>">How Deal With Very Bad BOOK</a>
                                            </h3>
                                        </div>
                                        <div class="product-card--body">
                                            <div class="card-image">
                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="<?php echo e(url('product-details')); ?>" tabindex="0">OMG! The Best BOOK
                                                        Ever!</a></h3>
                                            </div>
                                            <article>
                                                <h2 class="sr-only">Card List Article</h2>
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="<?php echo e(url('product-details')); ?>">The Hidden Mystery Behind</a></h3>
                                        </div>
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="<?php echo e(asset('public/webpages/assets/image/products/product-10.jpg')); ?>"
                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="<?php echo e(url('product-details')); ?>" tabindex="0">BOOK: Do You
                                                        Really Need
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="<?php echo e(url('product-details')); ?>">Little Known Ways To Rid
                                                    Yourself</a>
                                            </h3>
                                        </div>
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                ...
                                                <div class="hover-contents">
                                                    <a href="<?php echo e(url('product-details')); ?>" class="hover-image">
                                                        <img src="<?php echo e(asset('public/webpages/assets/image/products/product-12.jpg')); ?>"
                                                            alt="">
                                                    </a>
                                                    <div class="hover-btns">
                                                        <a href="#" class="single-btn">
                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="<?php echo e(url('product-details')); ?>" tabindex="0">Revolutionize Your
                                                        BOOK
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="<?php echo e(url('product-details')); ?>">Qple GPad with Retina Sisplay</a>
                                            </h3>
                                        </div>
                                        <div class="product-card--body">
                                            <div class="card-image">
                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="<?php echo e(url('product-details')); ?>" tabindex="0">Here Is A Quick
                                                        Cure For
                                                        Book</a></h3>
                                            </div>
                                            <article>
...
</html><?php /**PATH C:\xampp\htdocs\bookfactory17\bookfactory\resources\views/webpages/result.blade.php ENDPATH**/ ?>