    ...
    <div class="site-wrapper" id="top">
        ...
        <main class="inner-page-sec-padding-bottom">
            <div class="container-fluid">
                            ...
                            <div class="row ">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <div class="w-100 df-row-cc">
                                                ...
                                                <div class="w-25 df-col-cc">
                                                    <img src="<?php echo e(asset('public/webpages/assets/image/delivery-man.png')); ?>" alt=""
                                                        class="delivery-icon">
                                                    <span class="delivery-span">Guaranteed Services</span>
                                                </div>

                                                <div class="w-25 df-col-cc">
                                                    <img src="<?php echo e(asset('public/webpages/assets/image/international.png')); ?>" alt=""
                                                        class="delivery-icon">

                                                    <span class="delivery-span">International Shipping</span>
                                                </div>
                                                <div class="w-25 df-col-cc">
                                                    <img src="<?php echo e(asset('public/webpages/assets/image/delivery.png')); ?>" alt=""
                                                        class="delivery-icon">
                                        ...
                                        <div class="col-12 mt-3">
                                            <a href="#"> <i class="fas fa-angle-right mr-2"></i><strong> Print On Demand</strong> </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="mt-4 pincode-store df-row-ss">
                                        <img src="<?php echo e(asset('public/webpages/assets/image/shop.png')); ?>" alt="" class="shop-icon">
                ...
                <section>
                    <div class="container">
                    <div class="sb-custom-tab review-tab section-padding mt-5">
                                ...
                                <div class="col-12 w-100">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"><span><strong><i
                                                    class="fas fa-angle-right mr-2"></i>Author </strong></span>
                                                </div>
                                                <div class="col-md-8"><span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4"><span><strong><i
                                                                class="fas fa-angle-right mr-2"></i>H x L x W </strong></span>
                                                </div>
                                                <div class="col-md-8"><span>15cm X 180cm X 29cm</span></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4"><span><strong><i
                                                                class="fas fa-angle-right mr-2"></i>Weight </strong></span>
                                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\bookfactory17\bookfactory\resources\views/webpages/product-details.blade.php ENDPATH**/ ?>