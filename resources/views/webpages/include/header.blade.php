        ...
        <div class="row">
            ...
            <div class="col-lg-8 flex-lg-right">
                <ul class="header-top-list">
                    ...
                    <li class="dropdown-trigger language-dropdown"><a href="{{url('wishlist')}}"><i
                                class="icons-left fas fa-heart"></i>
                            wishlist (0)</a>
                    </li>
                    <li class="dropdown-trigger language-dropdown"><a href="{{url('my-account')}}"><i
                                ...
                                <div class="cart-dropdown-block">
                                    <div class=" single-cart-block ">
                                        <div class="cart-product">
                                            ...
                                            <div class="content">
                                                <h3 class="title"><a href="{{url('cart')}}">Demo Book</a></h3>
