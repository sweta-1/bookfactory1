...
<body>
    ...
    <div class="site-wrapper" id="top">
                ...
                <div class="single-slide bg-shade-whisper">
                    <div class="container">
                        <div class="home-content text-center text-sm-left position-relative">
                            <div class="hero-partial-image image-right pl-5">
                                <img src="{{asset('public/webpages/assets/image/s1.png')}}" style>

                            </div>
                            <div class="row no-gutters ">
                                <div class="col-xl-6 col-md-6 col-sm-7">
                                    <div class="home-content-inner content-left-side">
                                        <h1>FRM Exam part 1<br>
                                            </h1>
                                        <h2>Get an inside look at Kaplan Schweser’s cornerstone FRM® Exam review tool.</h2>
                                        <a href="{{url('#')}}" class="mt-5 btn btn-outlined--primary">
                                            ₹200 - Order Now!
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        <div class="home-content text-center text-sm-left position-relative">
                            <div class="hero-partial-image image-left">
                                ...
                                <img src="{{asset('public/webpages/assets/image/s2.png')}}">
                ...
                <div class="row space-db--30">
                    <div class="col-lg-6 col-md-6 d-flex flex-row justify-content-center align-items-center mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img src="{{asset('public/webpages/assets/image/gmat-banner-final-cream3.jpg')}}">

                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img src="{{asset('public/webpages/assets/image/p2.webp')}}">
                            ...
                            {"breakpoint":320, "settings": {"slidesToShow": 2} }
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            ...
                                            <div class="product-header">
                                                ...
                                                <h3><a href="{{url('product-details')}}">Demo Book</a></h3>
                                            </div>
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img
                                                    src="{{asset('public/webpages/assets/image/products/product-2.jpg')}}">

                                                <div class="hover-contents">
                                                    <a href="{{url('product-details')}}" class="hover-image">
                                                        <img
                                                            src="{{asset('public/webpages/assets/image/products/product-3.jpg')}}">
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{url('product-details')}}">Demo Book</a>
                                            </h3>
                                        </div>
                                        <div class="product-card--body">
                                            <div class="card-image">
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img
                                                    src="{{asset('public/webpages/assets/image/products/product-4.jpg')}}">
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="{{asset('public/webpages/assets/image/products/product-6.jpg')}}"
                                                    alt="">
                                                <div class="hover-contents">
                                                    <a href="{{url('product-details')}}" class="hover-image">
                                                        <img src="{{asset('public/webpages/assets/image/products/product-7.jpg')}}"
                                                            alt="">
                                                    </a>
                                                    <div class="hover-btns">
                                                        <a href="#" class="single-btn">
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="{{asset('public/webpages/assets/image/products/product-8.jpg')}}"
                                                    alt="">
                                                <div class="hover-contents">
                                                    <a href="{{url('product-details')}}" class="hover-image">
                                                        <img src="{{asset('public/webpages/assets/image/products/product-9.jpg')}}"
                                                            alt="">
                                                    </a>
                                                    <div class="hover-btns">
                                                        <a href="#" class="single-btn">
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="{{asset('public/webpages/assets/image/products/product-10.jpg')}}"
                                                    alt="">
                                                <div class="hover-contents">
                                                    <a href="{{url('product-details')}}" class="hover-image">
                                                        <img src="{{asset('public/webpages/assets/image/products/product-11.jpg')}}"
                                                            alt="">
                                                    </a>
                                                    <div class="hover-btns">
                                                        <a href="#" class="single-btn">
                                ...
                                <div class="single-slide">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="{{asset('public/webpages/assets/image/products/product-12.jpg')}}"
                                                    alt="">
                                                <div class="hover-contents">
                                                    <a href="{{url('product-details')}}" class="hover-image">
                                                        <img src="{{asset('public/webpages/assets/image/products/product-11.jpg')}}"
                ...
                {"breakpoint":490, "settings": {"slidesToShow": 2} }
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            <div class="product-header">
                                ...
                                <h3><a href="{{url('product-details')}}">Demo Book
                                    </a>
                                </h3>
                            </div>
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('public/webpages/assets/image/products/product-2.jpg')}}" alt="">
                                    <div class="hover-contents">
                                        <a href="{{url('product-details')}}" class="hover-image">
                                            <img src="{{asset('public/webpages/assets/image/products/product-1.jpg')}}"
                                                alt="">
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('public/webpages/assets/image/products/product-1.jpg')}}" alt="">
                                    <div class="hover-contents">
                                        <a href="{{url('product-details')}}" class="hover-image">
                                            <img src="{{asset('public/webpages/assets/image/products/product-1.jpg')}}"
                                                alt="">
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('public/webpages/assets/image/products/product-3.jpg')}}" alt="">
                                    <div class="hover-contents">
                                        <a href="{{url('product-details')}}" class="hover-image">
                                            <img src="{{asset('public/webpages/assets/image/products/product-2.jpg')}}"
                                                alt="">
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('public/webpages/assets/image/products/product-5.jpg')}}" alt="">
                                    <div class="hover-contents">
                                        <a href="{{url('product-details')}}" class="hover-image">
                                            <img src="{{asset('public/webpages/assets/image/products/product-4.jpg')}}"
                                                alt="">
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('public/webpages/assets/image/products/product-6.jpg')}}" alt="">
                                    <div class="hover-contents">
                                        <a href="{{url('product-details')}}" class="hover-image">
                                            <img src="{{asset('public/webpages/assets/image/products/product-4.jpg')}}"
                                                alt="">
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('public/webpages/assets/image/products/product-8.jpg')}}" alt="">
                                    <div class="hover-contents">
                                        <a href="{{url('product-details')}}" class="hover-image">
                                            <img src="{{asset('public/webpages/assets/image/products/product-7.jpg')}}"
                                                alt="">
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="{{asset('public/webpages/assets/image/products/product-13.jpg')}}" alt="">
                                    <div class="hover-contents">
                                        <a href="{{url('product-details')}}" class="hover-image">
                                            <img src="{{asset('public/webpages/assets/image/products/product-11.jpg')}}"
                                                alt="">
        ...
        <section class="section-margin bg-image section-padding-top section-padding"
            data-bg="{{asset('public/webpages/assets/image/bg-images/best-seller-bg.jpg')}}">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6">
                            <div class="author-image">
                                <img src="{{asset('public/webpages/assets/image/others/best-seller-author.jpg')}}"
                                    alt="">
                                    ...
                                    <div class="product-card card-style-list">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="{{url('product-details')}}">What You Can Learn From Bill
                                                        Gates
        ...
        <section class="section-margin">
            <div class="promo-wrapper promo-type-three">
                <a href="#" class="promo-image promo-overlay bg-image"
                    data-bg="{{asset('public/webpages/assets/image/bg-images/promo-banner-full.jpg')}}">
                </a>
            ...
            <div class="container">
                ...
                {"breakpoint":1200, "settings": {"slidesToShow": 1} }
                    ...
                    <div class="single-slide">
                        <div class="blog-card">
                            <div class="image">
                                <img src="{{asset('public/webpages/assets/image/others/blog-grid-2.jpg')}}" alt="">
                            </div>
                            <div class="content">
                                <div class="content-header">
                                    <div class="date-badge">
                    ...
                    <div class="single-slide">
                        <div class="blog-card">
                            <div class="image">
                                <img src="{{asset('public/webpages/assets/image/others/blog-grid-3.jpg')}}" alt="">
                            </div>
                            <div class="content">
                                <div class="content-header">
                                    <div class="date-badge">
            ...
            <div class="col-md-7 border-right border-bottom">
                ...
                <div class="row">
                    <div class="col-12 df-row-cc mt-2">
                        <a href="{{url('')}}" class="btn  product-buy-button">ADD TO CART</a>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 mt-3">
                        <a href="#"> <i class="fas fa-angle-right mr-2"></i><strong> Print On
                                Demand</strong> </a>
                    </div>
                </div>
            </div>
