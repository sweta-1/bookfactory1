						...
						<form action="./">
							...
							<div class="cart-table table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td class="pro-thumbnail"><a href="#">  <img src="{{asset('assets/image/products/product-details-1.jpg')}}" alt=""></a></td>
										...
										<tr>
											<td class="pro-thumbnail"><a href="#">  <img src="{{asset('assets/image/products/product-details-2.jpg')}}" alt=""></a></td>
										...
										<tr>
											<td class="pro-thumbnail"><a href="#">  <img src="{{asset('assets/image/products/product-details-3.jpg')}}" alt=""></a></td>
										...
										<tr>
											<td class="pro-thumbnail"><a href="#">  <img src="{{asset('assets/image/products/product-details-4.jpg')}}" alt=""></a></td>
